...
function SessionsSkeletonCard() {
  return (
    <Card className="border-white/45 bg-white/66 shadow-sm backdrop-blur-md dark:border-white/15 dark:bg-white/7">
  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 mx-auto w-full max-w-5xl px-4 py-8 sm:px-6 sm:py-12">
        <section className="rounded-3xl border border-white/45 bg-white/56 p-5 shadow-sm backdrop-blur-xl animate-in fade-in duration-300 sm:p-7 dark:border-white/15 dark:bg-[#0d1222]/58">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <Card className="border-white/45 bg-white/66 shadow-sm backdrop-blur-md md:col-span-2 dark:border-white/15 dark:bg-white/7">
              <CardHeader className="space-y-2">
